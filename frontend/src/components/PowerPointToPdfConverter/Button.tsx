...
export const Button: FC<ButtonProps> = ({isLoading, variant, disabled, children, ...props}) => {
    return <button
        className={
            `flex w-full items-center justify-center rounded-lg border shadow-sm disabled:cursor-not-allowed disabled:opacity-30 px-4 py-2.5 font-semibold  text-[14px]/[20px]
            ${
                variant === "primary" 
